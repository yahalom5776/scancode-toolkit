...
patterns = [
    ...
    # year or year range
    ('^\(?(19|20)[0-9]{2}(\s*([\,\-\;\.\:]|to)?\s*(19|20)?[0-9]{2})*\)?$', 'YR'),
    ('^((19|20)[0-9]{2}\s*[\,\-\;\.\:]?)+$', 'YR'),
    ('^(\(?(19|20)[0-9]{2}\s*[\,\-\;\.\:]?\)?)+$', 'YR'),
    ('^(\(?(19|20)[0-9]{2}\s*\)?[\,\-\;\.\:]?)+$', 'YR'),
    ('^(19|20)[0-9]{2}(\s*([\,\-\;\.\:]|to)?\s*(19|20)?[0-9]{2})*$', 'YR'),
    ('^(19|20)[0-9]{2}-(19|20)?[0-9]{1}$', 'YR'),

#     (r'^[(]?' # optionally wrapped in parens
#      # plain year 
#      r'(19|20)[0-9]{2}' 
#      # optionally followed by spaces, a comma dash or "to" and another year
#      r'('
#       r'(\s)*'
#       r'([,-]|to)'
#       r'(\s)*'
